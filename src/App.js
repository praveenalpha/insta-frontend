...
class App extends Component {
  ...
  isCommentHandler = (cmntsArr)=>{
    console.log(cmntsArr)
    this.setState({
        ...
        <React.Fragment>
          ...
          <Route path="/" exact>
            {this.state.isAuth ? <div className="content">
              <Feeds uid = {this.state.uid} user = {this.state.user} isCommentHandler = {this.isCommentHandler} />
              <ProfileView uid = {this.state.uid} getUser = {this.getUser} />
              {this.state.isComment && <Comments isCommentHandler = {this.isCommentHandler} cmntArr = {this.state.comments} />}
