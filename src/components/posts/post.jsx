    ...
    componentDidMount(){
        ...
        axios.get(`/api/like/${this.state.p_id}`).then( (obj) =>{
            ...
            return axios.get(`/api/comment/${this.state.p_id}`);
                ...
                object2 = obj2;
                if(object.data.data){
                    console.log("inside posts comments are : ", object2.data.data);
                    ...
                    <div className="post-container">
                        ...
                        <div className="post-body">
                            ...
                            <div className="like-count">
                                {this.state.likes}likes<br />
                                <span className = "like-count-span-cmnt" onClick = {() => this.props.isCommentHandler(this.state.my_comments)}>{this.state.cmnt}comments</span><br />
